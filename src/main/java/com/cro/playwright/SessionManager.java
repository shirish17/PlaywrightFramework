...
public final class SessionManager {
	 ...
	 private static final Object BROWSER_LOCK = new Object();
	    ...
	    /**
	     * Create or reuse session with ReadWriteLock protection.
	     */
	    public static void createOrReuseSession(String role, LoginCallback loginCallback) {
	        ...
	        // CRITICAL: Acquire read lock BEFORE context creation
	        BrowserManager.acquireContextCreationLock();
	        try {
	            ...
	            // CRITICAL: Release read lock AFTER context creation
	            BrowserManager.releaseContextCreationLock();
	        }
	     ...
	     * Called from inside synchronized block.
	     */
